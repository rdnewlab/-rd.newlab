...
const NOI_DUNG_DU_PHONG = {
  ...
  caiDat: {
    ...
    nguoiSauY:       'Thành thạo bào chế công thức: thực phẩm · mỹ phẩm · hoá mỹ phẩm|Nắm quy trình sản xuất, thiết kế bố trí dây chuyền chạy được|Hiểu thiết bị nhà máy, chuẩn GMP và ISO|Rành thủ tục và pháp luật của từng ngành|Ứng dụng AI vào công việc mỗi ngày|Hơn 10 năm trong nghề — không phải dân lập trình thuần',
